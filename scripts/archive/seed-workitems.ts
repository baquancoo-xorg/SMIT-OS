...
const workItems = [
  // Tech Tasks
  { type: 'Epic', title: 'Tối ưu FE & Cloudflare xử lý triệt để lỗi Proxy', description: 'Đã xử lý xong file JS lớn và chuyển đổi định dạng ảnh webp. Lỗi đã giảm xuống <10%.', priority: 'Urgent', status: 'Done', sprint: 1, dueDate: '2026-03-28', assignee: 'Đăng Khoa' },
  { type: 'Task', title: 'Xin quyền Ads Standard App FB v1 & v2', description: 'Đã gửi video review và xin thành công quyền cho 2 app đầu tiên.', priority: 'High', status: 'Done', sprint: 1, dueDate: '2026-04-01', assignee: 'Thái Phong' },
  { type: 'Epic', title: 'Phát triển tính năng "Aha Block" (UI & Logic)', description: 'Chủ nhật đã review code, Thứ 2 (13/4) tiến hành Deploy lên Production.', priority: 'Urgent', status: 'Review', sprint: 2, dueDate: '2026-04-14', assignee: 'Đăng Khoa' },
  { type: 'Task', title: 'Xin quyền App FB v3 & v4', description: 'Đang quay video review để xin quyền page_metadata. Sẽ gửi xin cách ngày để tránh Meta nghi ngờ.', priority: 'Medium', status: 'In Progress', sprint: 2, dueDate: '2026-04-16', assignee: 'Thái Phong' },
  { type: 'Epic', title: 'Hoàn thiện MVP SMIT Chat (Bản 80%)', description: 'Chiều thứ 3 (14/4) sẽ có bản MVP. Thứ 5 hoàn thiện 100% trải nghiệm và logic để test.', priority: 'High', status: 'Review', sprint: 2, dueDate: '2026-04-16', assignee: 'Huy Hoàng' },
  { type: 'Task', title: 'Tích hợp PostHog & In-app Tracking', description: 'Đã đấu nối FE. Đang mắc ở khâu tracking event rơi rớt vì web chưa chốt khung (chờ MKT).', priority: 'High', status: 'In Progress', sprint: 2, dueDate: '2026-04-15', assignee: 'Thái Phong' },
  { type: 'Task', title: 'Nghiên cứu tính năng Quản lý Page & Super Share', description: 'Nghiên cứu tính khả thi của API. Estimate thời gian hoàn thành luồng này.', priority: 'Medium', status: 'Todo', sprint: 2, dueDate: '2026-04-18', assignee: 'Giang Trường' },
  { type: 'Task', title: 'Triển khai AI Review Code tự động', description: 'Setup Agent tự động check bug trước khi merge code vào nhánh chính trên Github.', priority: 'High', status: 'In Progress', sprint: 2, dueDate: '2026-04-17', assignee: 'Thái Phong' },
  { type: 'UserStory', title: 'Đấu API hiển thị tỷ giá ngoại tệ theo ngày', description: 'Cập nhật luồng đổi tỷ giá tiền tệ realtime theo API ngân hàng.', priority: 'Low', status: 'Todo', sprint: 2, dueDate: '2026-04-19', assignee: 'Huy Hoàng' },
