    ...
    const fetchData = async () => {
      try {
        ...
        if (res.ok) {
          ...
          setItems(data.filter((item: WorkItem) => item.type === 'Deal' || item.type === 'SaleTask'));
        }
      } catch (error) {
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white p-6 rounded-2xl border border-outline-variant/10 shadow-sm flex items-center gap-4">
          ...
          <div>
            ...
            <h4 className="text-xl font-black font-headline">550M</h4>
          </div>
        </div>
        <div className="bg-white p-6 rounded-2xl border border-outline-variant/10 shadow-sm flex items-center gap-4">
          ...
          <div>
            ...
            <h4 className="text-xl font-black font-headline">8</h4>
          </div>
        </div>
        <div className="bg-white p-6 rounded-2xl border border-outline-variant/10 shadow-sm flex items-center gap-4">
          ...
          <div>
            ...
            <h4 className="text-xl font-black font-headline">32%</h4>
          </div>
        </div>
      </div>
