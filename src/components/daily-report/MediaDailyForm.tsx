...
import { MediaMetrics, TaskEntry, BLOCKER_TAGS } from '../../types/daily-report-metrics';
...
const DEFAULT_MEDIA_METRICS: MediaMetrics = { version: 'demo', prodStatus: 'editing', revisionCount: 'v1' };
