...
import { v5BrandTokens, v5ThemeTokens } from '../../../../design/v5/tokens';

export const chartColors = {
  // Sequential brand palette (8 colors for multi-series)
  series: [
    v5BrandTokens.brand500, // Primary orange
    '#3b82f6', // Blue
    '#10b981', // Green
    '#f59e0b', // Amber
    '#8b5cf6', // Purple
  ...
  getThemeColors: (theme: 'dark' | 'light') => ({
    text: theme === 'dark' ? v5ThemeTokens.dark.text2 : v5ThemeTokens.light.text2,
    grid: theme === 'dark' ? 'rgba(255,255,255,0.08)' : 'rgba(0,0,0,0.08)',
    axis: theme === 'dark' ? v5ThemeTokens.dark.text2 : v5ThemeTokens.light.text2,
    tooltip: {
      bg: theme === 'dark' ? v5ThemeTokens.dark.surface2 : v5ThemeTokens.light.surface,
      border: theme === 'dark' ? 'rgba(255,255,255,0.1)' : 'rgba(0,0,0,0.1)',
      text: theme === 'dark' ? v5ThemeTokens.dark.text1 : v5ThemeTokens.light.text1,
    },
  }),
} as const;
